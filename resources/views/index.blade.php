...
<body>
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="{{ url('/') }}"><img src="assets/img/logo.png" alt="Edura"></a>
            </div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button">
                                <a href="{{url('login')}}" class="th-btn ml-25">Login/Register</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="logo-bg" data-bg-src="assets/img/bg/logo-bg-3.png">
            </div>
        </div>
    </header> --}}
                                ...
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-auto d-none d-xl-block">
                                        <div class="header-button">
                                            ...
                                            <a href="{{ url('login') }}"
                                                class="th-btn style8 d-none d-xxl-inline-block">Apply Now<i
    ...
    <div class="th-hero-wrapper hero-3" id="hero">
        <div class="hero-slider-2 th-carousel" data-fade="true" data-slide-show="1" data-md-slide-show="1"
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_3_1.jpg"></div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12">
                            <div class="hero-style3 text-center">
                                <span class="hero-subtitle text-white" data-ani="slideinup" data-ani-delay="0.1s">The
                                    World’s Best Institute Of</span>
                                <h1 class="hero-title text-white" data-ani="slideinup" data-ani-delay="0.4s">Online
                                    Education</h1>
                                ...
                                <div class="btn-group justify-content-center" data-ani="slideinup"
                                    data-ani-delay="0.7s">
                                    <a href="{{ url('login') }}" class="th-btn style3">Admission Now<i
            ...
            <div class="th-hero-slide">
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12">
                            <div class="hero-style3 text-center">
                                <span class="hero-subtitle text-white" data-ani="slideinup"
                                    data-ani-delay="0.1s">Unlock The Power Of Learning</span>
                                <h1 class="hero-title text-white" data-ani="slideinup" data-ani-delay="0.4s">Empower
                                    Your Future</h1>
                                <div class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.5s">
                                    <p>Admission Going On, Hurry To Enroll Now </p>
                                    <ul class="counter-list cta-countdown" data-offer-date="10/24/2023">
        ...
        <div class="container">
            ...
            <div class="row th-carousel service-slider1 slider-shadow" data-slide-show="4" data-ml-slide-show="3"
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        <div class="service-card-icon">
                            <img class="svg-img" src="assets/img/icon/service-icon-1-1.svg" alt="icon">
                        </div>
                        <div class="service-card-content">
                            <h3 class="box-title"><a href="service-details.html">Exclusive Advisor</a></h3>
                            <p class="service-card-text">Monotonically conceptualize cutting-edge convergence whereas
                                B2C networks.</p>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        <div class="service-card-icon">
                            <img class="svg-img" src="assets/img/icon/service-icon-1-2.svg" alt="icon">
                        </div>
                        <div class="service-card-content">
                            <h3 class="box-title"><a href="service-details.html">Study Off Flexibly</a></h3>
                            <p class="service-card-text">Discover different career paths and industries, along with the
                                required skills, education.</p>
                            <div class="service-card-img">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        <div class="service-card-icon">
                            <img class="svg-img" src="assets/img/icon/service-icon-1-3.svg" alt="icon">
                        </div>
                        <div class="service-card-content">
                            <h3 class="box-title"><a href="service-details.html">Online Certificates</a></h3>
                            <p class="service-card-text">Gain insights into how parents can support their childs
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        <div class="service-card-icon">
                            <img class="svg-img" src="assets/img/icon/service-icon-1-4.svg" alt="icon">
                        </div>
                        <div class="service-card-content">
                            <h3 class="box-title"><a href="service-details.html">Evidence of learned</a></h3>
                            <p class="service-card-text">Access a range of teaching strategies, lesson plans, classroom
                                management.</p>
                            <div class="service-card-img">
    ...
    <div class="overflow-hidden " data-bg-src="assets/img/bg/about-3-bg.png" id="about-sec">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="img-box3">
                        <img class="img-1 tilt-active" src="assets/img/normal/about_3_1.png" alt="About">
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="space">
                        ...
                        <p class="mt-n2 mb-30">Synergistically visualize alternative content before cross functional
                            core Rapidiously administra standardized value via focused benefits. Rapidiously redefine
                            highly efficient niche markets with plug-and-play materials professionally seize client
                            centric solutions</p>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="mt-3">Join us on our journey as we continue to innovate & shape the future
                                    of education.</p>
                            </div>
                            <div class="col-md-6">
                                <div class="about-grid2">
                                ...
                                <p class="mt-3">We believe that education is fundamental right and a catalyst for
                                    personal growth.</p>
                            </div>
                        </div>
                        <div class="btn-group mt-15">
                            <a href="about.html" class="th-btn">LEARN MORE<i
                                    class="fa-regular fa-arrow-right ms-2"></i></a>
                            <a href="about.html" class="th-btn style7">CONTACT US<i
                                    class="fa-regular fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        ...
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Web Development</a></h3>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_2.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Digital Marketing</a></h3>
                            <span class="category-list_text">132 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_3.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">UI/UX Design</a></h3>
                            <span class="category-list_text">152 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_4.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Graphic Design</a></h3>
                            <span class="category-list_text">210 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_5.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Physic Pro Course</a></h3>
                            <span class="category-list_text">240 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_6.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Music Production</a></h3>
                            <span class="category-list_text">253 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_7.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Marketing Course</a></h3>
                            <span class="category-list_text">154 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_8.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Business Growth</a></h3>
                            <span class="category-list_text">148 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_9.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Lifestyle Course</a></h3>
                            <span class="category-list_text">195 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_10.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Social Activities</a></h3>
                            <span class="category-list_text">205 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_11.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">SEO Marketing</a></h3>
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="category-list">
                        <div class="category-list_icon">
                            <img src="assets/img/icon/category_2_12.svg" alt="icon">
                        </div>
                        <div class="category-list_content">
                            <h3 class="category-list_title"><a href="course.html">Ethical Hacking</a></h3>
                            <span class="category-list_text">200 Courses</span>
                            <a href="course.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="why-sec-v2 overflow-hidden space" data-bg-src="assets/img/bg/why-bg-2.png">
        <div class="shape-mockup why2-shape-1 spin" data-top="40%" data-right="6%">
            <img src="assets/img/normal/wcu_2_shape1.png" alt="img">
        </div>
                    ...
                    <div class="wcu-wrap2">
                        ...
                        <div class="row g-4">
                            <div class="col-sm-6">
                                <div class="wcu-box style2">
                                    <div class="wcu-box_icon">
                                        <img src=assets/img/icon/wcu-icon-2-1.svg alt="img">
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="wcu-box style2">
                                    <div class="wcu-box_icon">
                                        <img src=assets/img/icon/wcu-icon-2-2.svg alt="img">
                                    </div>
                                    <div class="wcu-box_details">
                            ...
                            <div class="col-sm-6">
                                <div class="wcu-box style2">
                                    <div class="wcu-box_icon">
                                        <img src=assets/img/icon/wcu-icon-2-3.svg alt="img">
                                    </div>
                                    <div class="wcu-box_details">
                            ...
                            <div class="col-sm-6">
                                <div class="wcu-box style2">
                                    <div class="wcu-box_icon">
                                        <img src=assets/img/icon/wcu-icon-2-4.svg alt="img">
                                    </div>
                                    <div class="wcu-box_details">
                                        <h3 class="h5 wcu-box_title"><a href="service-details.html">Learn Anywhere</a>
                                        </h3>
                                        <p class="wcu-box_text">Online education often allows learners to study at
                                            their own pace.</p>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="space" id="course-sec">
        <div class="container">
            ...
            <div class="row gy-4 filter-active mb-60">
                ...
                <div class="col-md-6 col-xxl-3 col-lg-4 filter-item cat4 cat2 cat3">
                    <div class="course-box style2">
                        <div class="course-img">
                ...
                <div class="col-md-6 col-xxl-3 col-lg-4 filter-item cat4 cat1 cat2">
                    <div class="course-box style2">
                        <div class="course-img">
                ...
                <div class="col-md-6 col-xxl-3 col-lg-4 filter-item cat3 cat1">
                    <div class="course-box style2">
                        <div class="course-img">
        ...
        <div class="container text-center">
            <div class="cta-wrap2">
                <div class="title-area text-center mb-35">
                    ...
                    <h2 class="sec-title text-white">40% Offer First <span class="text-theme2">100 Student’s</span>
                        For Featured <br> <span class="fw-normal">Topics by Education Category</span></h2>
                ...
                <div class="btn-group justify-content-center">
                    <a href="about.html" class="th-btn style3">Join With Us<i
                            class="fas fa-arrow-right ms-2"></i></a>
                ...
                <div class="row gy-50 justify-content-center">
                    <div class="col-md-6 col-lg-4 process-card-wrap">
                        <div class="process-card">
                            ...
                            <p class="process-card_text">Standards in leadership skills synergize optimal expertise
                                rather than innovative leadership skills and better learning.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 process-card-wrap">
                        <div class="process-card">
                            ...
                            <p class="process-card_text">We provide online learning program that enable learners to
                                access high-quality education remotely.</p>
                        </div>
                        <div class="process-arrow">
                            <img src="assets/img/icon/process-arrow.svg" alt="line">
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 process-card-wrap">
                        <div class="process-card">
                            ...
                            <p class="process-card_text">These programs cover a wide range of subjects and can be
                                customized for individual learners or delivered to schools.</p>
                        </div>
                        <div class="process-arrow">
                            <img src="assets/img/icon/process-arrow.svg" alt="line">
                        </div>
    ...
    <section class="testi-area-3 bg-smoke overflow-hidden space">
        ...
        <div class="container-fluid">
            <div class="row slider-shadow th-carousel testi-slider-3" data-slide-show="3" data-ml-slide-show="2"
                data-lg-slide-show="2" data-md-slide-show="1" data-arrows="true" data-xl-arrows="true"
                data-ml-arrows="true">
                <div class="col-lg-6">
                    <div class="testi-box style2">
                        ...
                        <div class="testi-box-bg-shape">
                            <svg width="78" height="111" viewBox="0 0 78 111" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 0L78 30V71C78 93.0914 60.0914 111 38 111H10C4.47715 111 0 106.523 0 101V0Z"
                                    fill="#0D5EF4" />
                            </svg>
                        </div>
                        <div class="testi-box_content">

                            <p class="testi-box_text">“Quickly maximize visionary solutions after mission critical
                                action item productivity premium portals for impactful -services inactively negotiate
                                enabled niche markets via growth strategies. University is accredited by the Higher
                                Learning Commission.</p>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="testi-box style2">
                        ...
                        <div class="testi-box_content">
                            ...
                            <p class="testi-box_text">They were able to provide me with a range of options for my roof
                                replacement, item productivity premium portals for impactful -services inactively
                                negotiate enabled niche markets via growth strategies. University is accredited by the
                                Higher Learning.</p>
                        </div>
                        <div class="testi-box_bottom">
                            <div class="testi-box_img">
                ...
                <div class="col-lg-6">
                    <div class="testi-box style2">
                        ...
                        <div class="testi-box_content">
                            ...
                            <p class="testi-box_text">They worked tirelessly to complete the job on time and the final
                                result item productivity premium portals for impactful -services inactively negotiate
                                enabled niche markets via growth strategies. University is accredited by the Higher
                                Learning Commission.</p>
                        </div>
                        <div class="testi-box_bottom">
                    ...
                    <div class="price-card ">
                        <div class="price-card_top">
                            ...
                            <h4 class="price-card_price">
                                $156.00 <span class="duration">/PER MONTHLY</span>
                            </h4>
                        </div>
                        <div class="price-card_content">
                            <div class="checklist">
                                <ul>
                                    ...
                                    <li class="unavailable"><i class="fa-regular fa-circle-xmark"></i> Certificate
                                        after completion</li>
                                    <li class="unavailable"><i class="fa-regular fa-circle-xmark"></i> Private
                                        sessions</li>
                                </ul>
                            </div>
                            <a href="pricing.html" class="th-btn style10">CHOOSE THE PLAN<i
                                    class="fa-regular fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="price-card active">
                        <div class="price-card_top">
                            ...
                            <h4 class="price-card_price">
                                $176.00 <span class="duration">/PER MONTHLY</span>
                            </h4>
                        </div>
                        <div class="price-card_content">
                            <div class="checklist">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="price-card ">
                        <div class="price-card_top">
                            ...
                            <h4 class="price-card_price">
                                $196.00 <span class="duration">/PER MONTHLY</span>
                            </h4>
                        </div>
                        <div class="price-card_content">
                            <div class="checklist">
    ...
    <!--============================== Blog Area ==============================-->
    <section class="blog-area-3 space" data-bg-src="assets/img/bg/blog-3-bg.png" id="blog-sec">
        <div class="shape-mockup blog-3-bg-shape1 jump" data-left="3%" data-bottom="10%">
            <img src="assets/img/normal/blog-3-bg-shape.png" alt="img">
        </div>
        <div class="container">
            ...
            <div class="row th-carousel" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="1"
                data-sm-slide-show="1" data-arrows="true">
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style4">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets/img/blog/blog-3-1.jpg"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html"><i class="fa-light fa-user"></i>by David
                                    Smith</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style4">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets/img/blog/blog-3-2.jpg"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                            ...
                            <h4 class="box-title"><a href="blog-details.html">Enrich Your Mind, Envision Your
                                    Future: Education for Success</a>
                            </h4>
                            <a href="blog-details.html" class="link-btn">Read More Details<i
                                    class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style4">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets/img/blog/blog-3-3.jpg"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                            ...
                            <h4 class="box-title"><a href="blog-details.html">University class starting soon while
                    ...
                    <div class="me-xxl-5 mt-60">
                        ...
                        <div class="contact-feature">
                            ...
                            <div class="media-body">
                                ...
                                <a href="https://www.google.com/maps" class="contact-feature_link">2690 Hiltona
                                    Street Victoria Road, <br> New York, Canada</a>
                            </div>
                        </div>
                        <div class="contact-feature">
                            <div class="contact-feature-icon">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="footer-logo">
                            {{-- <a href="index.html"><img src="assets/img/logo.png" alt="edura"></a> --}}
                            <a href="{{ url('/') }}"><img src="assets/img/logo.png" alt="Edura"></a>
                        </div>
                    </div>
                    <div class="col-lg-9">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget widget_contact footer-widget">
                            ...
                            <p class="contact-text">Fusce varius, dolor tempor interdum tristiquei bibendum service
                                life.</p>
